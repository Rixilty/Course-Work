...
class Login_GUI:
    ...
    def __init__(self):
        ...
        self.Title = ctk.CTkLabel(self.top_frame, text="Login", font=("Arial", 31, "bold"), text_color="white",
                                  fg_color="#1c1c1c")
        ...
        self.Username_label = ctk.CTkLabel(self.content_frame, text="Username:", font=("Arial", 13, "bold"),
                                           text_color="white", fg_color="#1c1c1c")
        self.Username_label.grid(row=1, column=0, sticky="e", padx=(0, 10))

        self.Username_entry = ctk.CTkEntry(self.content_frame, width=250, font=("Arial", 12),
                                           placeholder_text="Username", fg_color="white", text_color="black",
                                           placeholder_text_color="grey")
        self.Username_entry.grid(row=1, column=1, pady=5)

        self.Password_label = ctk.CTkLabel(self.content_frame, text="Password:", font=("Arial", 13, "bold"),
                                           text_color="white", fg_color="#1c1c1c")
        self.Password_label.grid(row=3, column=0, sticky="e", padx=(0, 10))

        self.Password_entry = ctk.CTkEntry(self.content_frame, width=250, font=("Arial", 12), show="*",
                                           placeholder_text="Password", fg_color="white", text_color="black",
                                           placeholder_text_color="grey")
        ...
        self.Login_button = ctk.CTkButton(self.bottom_frame, text="Login", fg_color="#1c1c1c", text_color="white",
                                          hover_color="#282828", border_width=1, border_color="#424242",
                                          font=("Arial", 14, "bold"), command=self.Login)
        self.Login_button.grid(row=5, column=0, columnspan=2, sticky="n", pady=(10, 0))

        self.error_label = ctk.CTkLabel(self.main_frame, text="", text_color="red", fg_color="#1c1c1c",
                                        font=("Arial", 14, "bold"))
        self.error_label.grid(row=6, column=0, columnspan=2, pady=(10, 0))

        self.not_signed_label = ctk.CTkLabel(self.bottom_frame, text="Don't have an account?",
                                             font=("Arial", 13, "bold"), text_color="white", fg_color="#1c1c1c")
        self.not_signed_label.grid(row=0, column=0, sticky="e")

        self.signup_link = ctk.CTkLabel(self.bottom_frame, text="Sign up.", font=("Arial", 13, "bold", "underline"),
                                        text_color="#001eff", fg_color="#1c1c1c", cursor="hand2")
        ...
        self.username_length_requirement = ctk.CTkLabel(self.username_requirements_frame,
                                                        text="● Username Length Must Be Between 3-16", text_color="red")
        ...
        self.uppercase_requirement = ctk.CTkLabel(self.password_requirements_frame,
                                                  text="● At least 1 Uppercase Letter", text_color="red")
        self.lowercase_requirement = ctk.CTkLabel(self.password_requirements_frame,
                                                  text="● At least 1 Lowercase Letter", text_color="red")
        self.digit_requirement = ctk.CTkLabel(self.password_requirements_frame, text="● At least 1 Number",
                                              text_color="red")
        self.symbol_requirement = ctk.CTkLabel(self.password_requirements_frame, text="● At least 1 Symbol",
                                               text_color="red")
        self.password_length_requirement = ctk.CTkLabel(self.password_requirements_frame,
                                                        text="● Password Length Must Be Between 8-16", text_color="red")
    ...
    def check_password_requirements(self, event=None):
        ...
        for i in [self.password_length_requirement, self.uppercase_requirement, self.lowercase_requirement,
                  self.digit_requirement, self.symbol_requirement]:

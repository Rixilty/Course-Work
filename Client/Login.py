...
class Login_GUI:
    ...
    def __init__(self):
        ...
        self.Title = tk.Label(self.main_frame, text="Login", font=("Arial", 24, "bold"), fg="white", bg="#1c1c1c")
        self.Title.grid(row=0, column=0, columnspan=2, pady=20)

        self.Username_label = tk.Label(self.main_frame, text="Username:", font=("Arial",10, "bold"), fg="white", bg="#1c1c1c")
        ...
        self.Password_label = tk.Label(self.main_frame, text="Password:", font=("Arial",10, "bold"), fg="white", bg="#1c1c1c")
        ...
        self.not_signed_label = tk.Label(bottom_frame, text="Don't have an account?", font=("Arial",10, "bold"), fg="white", bg="#1c1c1c")
        self.not_signed_label.grid(row=0, column=0)

        self.signup_link = tk.Label(bottom_frame, text="Sign up.", font=("Arial",10, "bold underline"), fg="#001eff", bg="#1c1c1c", cursor="hand2")
